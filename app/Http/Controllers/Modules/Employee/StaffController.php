...
class StaffController extends Controller
{
    public function store(Request $request)
    {
        ...
        $staff = User::create([
            ...
            'pension_employee' => $request->pension_employee,
            'pension_employer' => $request->pension_employer,
    ...
    public function bulkUpload(Request $request)
    {
        ...
        while (($data = fgetcsv($handle)) !== false) {
            ...
            User::create([
                ...
                'pension_employee' => $rowData['pension_employee'] ?? 0,
                'pension_employer' => $rowData['pension_employer'] ?? 0,
